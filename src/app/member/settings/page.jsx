...
import { PageHeader, Card, CardHeader, Button, Field, inputClass } from "@/components/ui";
...
export default function MemberSettingsPage() {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- seed once from /me/info
    setPrefs({
      email: p.email ?? true, whatsapp: p.whatsapp ?? true, in_app: p.in_app ?? true,
      language: p.language || "en", show_in_directory: p.show_in_directory ?? true,
    });
  }, [me, prefs]);
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Settings" subtitle="Notifications, language, privacy and account" />
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <div className="p-5">
            {/* <Field label="Language" hint="Your preferred language (saved to your profile).">
            ...
            <div className="mt-4 flex items-center justify-between">
              <span className="text-sm text-slate-700">Show me in the resident directory</span>
              <Toggle on={!!prefs?.show_in_directory} onClick={() => setPrefs({ ...prefs, show_in_directory: !prefs?.show_in_directory })} />
            </div>
            <div className="mt-4 flex justify-end">
              <Button icon="save" loading={savingPrefs} disabled={!prefs} onClick={savePrefs}>Save preferences</Button>
            </div>
          </div>
        </Card>
          ...
          <Card>
            ...
            <div className="flex items-center justify-between p-5">
              ...
              <Link href="/member/profile">
                <Button variant="secondary" icon="key-round">Change password</Button>
              </Link>
            </div>
          </Card>
